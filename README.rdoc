...
2.cd into the project and run bundle install to install necessary gems.

== Database creation

1.There is no need to run rake db:create and rake db:schema:load, because I upload the database into github. 
...
3. You will see 19 steps passed in green word

4. You can find the Scenario in TerminalAPI/features and you can find the step definitions in TerminalAPI/features/step_definitons.


== Services (job queues, cache servers, search engines, etc.)

1. To start rails server, just run rails s -b 0.0.0.0
