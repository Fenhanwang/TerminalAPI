...
class TerminalsControllerTest < ActionController::TestCase
  ...
  test "should create terminal" do
    assert_difference('Terminal.count') do
      post :create, terminal: { attributes: @terminal.attributes, description: @terminal.description, name: @terminal.name }
    end
  ...
  test "should update terminal" do
    patch :update, id: @terminal, terminal: { attributes: @terminal.attributes, description: @terminal.description, name: @terminal.name }
    assert_redirected_to terminal_path(assigns(:terminal))
  end
